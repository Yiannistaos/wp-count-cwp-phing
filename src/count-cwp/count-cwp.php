...
/**
 * Plugin Name:       Count Characters, Words and Paragraphs while editing[SHOW_PRO_ONLY_IF_IS_PRO]
 * Plugin URI:        https://www.web357.com/product/count-cwp-wordpress-plugin
